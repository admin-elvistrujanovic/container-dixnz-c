...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dixnz-c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dixnz-c.containers.anotherwebservice.com/
...
```
git clone git@github.com:admin-elvistrujanovic/container-dixnz-c.git
cd container-dixnz-c
```
...
```
docker attach container-dixnz-c
```
